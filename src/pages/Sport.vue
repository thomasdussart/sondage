...
export default {
  data() {
    return {
      questions: [
        {
          options: [
            "Créer un parcours de santé urbain en ville avec des défis sportifs",
            "Lancer une session hebdomadaire de sport en plein air dans un parc",
          ],
        },
        {
          options: [
            "Mettre en place un circuit d'initiation au parkour dans un parc local",
            "Organiser une journée d'initiation à des sports moins connus, comme le frisbee ou le tir à l'arc",
          ],
        },
        {
          options: [
            //prettier-ignore
            "Créer un \"défi sportif\" mensuel (course, marche, vélo) avec des objectifs à atteindre par école",
            "Lancer un tournoi sportif type intervilles entre les écoles",
          ],
        },
      ],
  ...
  methods: {
    ...
    markCategoryComplete() {
      ...
      if (!completedCategories.includes("Sport")) {
        completedCategories.push("Sport");
      }
